...
* **High-Speed Telemetry Pipeline (`uart_rx.v`, `uart_tx.v`):** Upgraded un-clocked asynchronous handshake link operating at **460,800 baud**, shrinking multi-byte frame payload transfers down to an ultralow ~17.01ms delivery window.
